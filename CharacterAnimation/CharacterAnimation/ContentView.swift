...
//  CharacterAnimation
//
//  Created by Victor Lee on 11/30/20.
//
...
struct ContentView: View {
    ...
    let characters = Array("VictorLee")
...
extension Color {
    ...
    func getDefaultColor1() -> Color {
        return Color.init(red: 0.40, green: 0.49, blue: 1.92)
    }

    static
    func getDefaultColor2() -> Color {
        return Color.init(red: 2.84, green: 0.43, blue: 0.46)
    }
}
